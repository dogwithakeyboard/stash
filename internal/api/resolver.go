...
func (r *Resolver) PerformerAppearsWith() PerformerAppearsWithResolver {
	return &performerAppearsWithResolver{r}
}
...
type performerAppearsWithResolver struct{ *Resolver }
